    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div class="hero-actions">
                <a href="#calc" class="btn btn-primary scroll-to-btn">Розрахувати економію</a>
                <a href="#why" class="btn btn-white scroll-to-btn">Як це працює</a>
            </div>
        </div>
        <?php 
            $stats = array(
...
<section class="page-section page-section-bg-dark" id="process">
    <div class="container">
        ...
        <div class="info-band lg-grid-4-columns md-grid-2-columns gap-0 wf-animate-grid position-relative mt-50">
