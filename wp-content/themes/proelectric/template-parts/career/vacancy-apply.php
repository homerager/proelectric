...
$apply_phones  = function_exists( 'proelectric_get_phones' ) ? proelectric_get_phones() : array();
?>
	...
	<div class="container">
		...
		<div class="contact-inner wf-animate-grid d-grid md-grid-2-columns md-gap-64">
			<div class="wf-animate">
				<div class="contact-detail d-flex gap-16">
					<div class="c-icon">
					...
					<div>
						...
						<?php foreach ( $apply_phones as $phone ) : ?>
